...
ActiveRecord::Schema.define(version: 20_180_724_195_507) do
  ...
  create_table 'flight_details', force: :cascade do |t|
    ...
    t.index %w[call_sign departure_time], name: 'index_flight_details_on_call_sign_and_departure_time'
  end
  ...
  create_table 'flight_price_archives', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[flight_id flight_date], name: 'index_flight_price_archives_on_flight_id_and_flight_date'
  end
  ...
  create_table 'flight_prices', force: :cascade do |t|
    ...
    t.index %w[flight_id flight_date], name: 'index_flight_prices_on_flight_id_and_flight_date'
  end
  ...
  create_table 'flights', force: :cascade do |t|
    ...
    t.index %w[route_id flight_number departure_time], name: 'index_flights_on_route_id_and_flight_number_and_departure_time', unique: true
  end
  ...
  create_table 'routes', force: :cascade do |t|
    ...
    t.index %w[origin destination], name: 'index_routes_on_origin_and_destination'
  end
  ...
  create_table 'search_histories', force: :cascade do |t|
    ...
    t.index %w[created_at supplier_name], name: 'index_search_histories_on_created_at_and_supplier_name'
