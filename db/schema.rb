...
ActiveRecord::Schema.define(version: 20171128142015) do
  ...
  create_table "user_flight_price_histories", force: :cascade do |t|
    t.string   "flight_id"
    t.string   "channel"
    t.datetime "created_at", default: '2017-11-30 15:42:03', null: false
    t.datetime "updated_at", default: '2017-11-30 15:42:03', null: false
  end
