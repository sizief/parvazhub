...
module SearchHelper
  ...
  def airplane_name_for(airplane_type)
    ...
    when 'MCDONNELLDOUGLASMD-83', 'MCDOUGLASMD-80SERIES', 'MD', 'MD8', 'BOINGMD-82', 'BOEINGMD-82', 'BOEINGMD-88', 'MD80', 'M82', 'MD-80', 'MD82', 'MD-82', 'MD83', 'MD-83', 'MD88', 'MD-88', 'MD.88', 'BOEINGMD', 'MS', 'M83', 'M80', 'BOEING-MD', 'MCDONNELLDOUGLASMD80', 'M88', 'MD8X', 'BOEINGMD-83', 'بوئينگ', 'MD-8X', 'BOEING','707'
      'بویینگ  ام دی'
    when 'AB3', 'Airbus'
      'ایرباس'
    ...
    when 'A313', 'AIRBUSA313'
      'ایرباس ۳۱۳'
    when 'A319', 'AIRBUSA319', '319', 'AIRBUS319', 'A319-100'
      'ایرباس ۳۱۹'
    when 'A321', 'AIRBUSA321', 'AIRBUS321'
      'ایرباس ۳۲۱'
    when 'A320', 'AIRBUSA320', '320', 'AIRBUS320', 'A320-200'
      'ایرباس ۳۲۰'
    when 'BOEING727-200', '727', '727-200', 'B727', 'B.727', 'BOEING727'
      'بویینگ ۷۲۷'
    when 'BOEING737-500(NOWINGLETS)', 'BOEING737-300(NOWINGLETS)','BOEING737(ALLSERIES-STAGE3)', 'B737', '737', '737-500', 'B737-400', '737-300', '737-600', '737-300', '737-700', '737-100', 'BOEING737', 'BOEING737-500'
      'بویینگ ۷۳۷'
    when '735'
      'بویینگ ۷۳۵'
