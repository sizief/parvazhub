...
var SearchResult = function SearchResult(props) {
  ...
  props.suppliers.forEach(function (supplier) {
    var supplierResult = new supplier(props.origin, props.destionation, props.date).search; //    setResults(merge(results, supplierResult))
  });
...
/******/ });
//# sourceMappingURL=search-results-05b451b1880747041243.js.map