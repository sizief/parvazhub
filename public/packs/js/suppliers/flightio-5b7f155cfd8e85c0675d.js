...
/***/ "./app/javascript/packs/suppliers/base.js":
/*!************************************************!*\
  !*** ./app/javascript/packs/suppliers/base.js ***!
  \************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Flightio; });
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/regenerator */ "./node_modules/@babel/runtime/regenerator/index.js");
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _models_flight__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../models/flight */ "./app/javascript/packs/models/flight.js");
/* harmony import */ var _base__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./base */ "./app/javascript/packs/suppliers/base.js");
...
var supplier_name = 'flightio';

var axios = __webpack_require__(/*! axios */ "./node_modules/axios/index.js");

var Flightio = /*#__PURE__*/function (_Base) {
  _inherits(Flightio, _Base);

  var _super = _createSuper(Flightio);

  function Flightio() {
    _classCallCheck(this, Flightio);

    return _super.apply(this, arguments);
  }

  _createClass(Flightio, [{
    key: "delay",
    ...
    value: function params() {
      return {
        ...
        "DestinationInformationList": [{
          "DepartureDate": "".concat(this.date, "T00:00:00"),
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                console.log(this.urlRegister); // const response = await axios.post(
                //   this.urlRegister,
                ...
                xhr.open("POST", this.urlRegister, false); //Send the proper header information along with the request

                xhr.setRequestHeader("Content-Type", "application/json");
                xhr.setRequestHeader("FUser", "FlightioAppAndroid");
                xhr.setRequestHeader("FPass", "Pw4FlightioAppAndroid");
                xhr.setRequestHeader("FApiVersion", "1.1"); //xhr.onreadystatechange = function() { // Call a function when the state changes.
                //    if (this.readyState === XMLHttpRequest.DONE && this.status === 200) {
                //        // Request finished. Do processing here.
                //   }
                // }

                xhr.send(JSON.stringify(this.params())); //    console.log(reponse)

                results = [new _models_flight__WEBPACK_IMPORTED_MODULE_1__["default"]({
                  id: null,
                  flightNumber: null,
                  departure: null,
                  arrival: null,
...
/******/ });
//# sourceMappingURL=flightio-5b7f155cfd8e85c0675d.js.map