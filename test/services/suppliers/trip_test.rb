...
class SuppliersTripTest < ActiveSupport::TestCase
  def setup
    ...
    @trip = Suppliers::Trip.new(
      origin: @origin,
      destination: @destination,
      route: @route,
      date: @date,
      search_history: @search_history.id,
  ...
  test 'calculate stop overs' do
    ...
    assert_equal  @trip.calculate_stopover_duration(['2017-11-19 18:00:00'.to_datetime], ['2017-11-19 18:00:00'.to_datetime]), 0
    assert_equal  @trip.calculate_stopover_duration(departures, arrivals), 180
  end
end
